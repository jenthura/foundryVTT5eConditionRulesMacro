function postToChat(imgURL, message){
  let chatData = {
  user: game.user._id,
  speaker: ChatMessage.getSpeaker(),
  content: `<div style="text-align: center"><img width=50% height=50% src="${imgURL}"</img></div><br>${message}`
};
...
eleven: {
  label: "Poisoned",
  callback: () => {postToChat(`https://s3.amazonaws.com/files.d20.io/images/55559874/XTkBXciYb4qBpHS0vkAQUA/med.png?1528351968`, `A poisoned creature has disadvantage on attack rolls and ability checks.`)}
 },
twelve: {
  label: "Prone",
